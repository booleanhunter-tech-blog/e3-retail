...
/**
 * Cleans search request query params into a appropriate format for use with Elasticsearch SDK
 * @typedef {import('../../models/products').SearchParams} SearchParams
 ...
 */
function sanitizeRequestQueryForSearch(searchRequest) {
    const searchParams = {
    ...
    if (searchRequest.delivery === 'next-day') {
 ...
 * @typedef {import('../../models/products').Aggregation} Aggregation
